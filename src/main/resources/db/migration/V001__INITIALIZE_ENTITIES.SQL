...
create table book (id bigint generated by default as identity, isbn varchar(255), page_count integer not null, title varchar(255), author_id bigint not null, primary key (id))
...
create table person (id bigint generated by default as identity, dob date, first_name varchar(255), gender integer, last_name varchar(255), passport_id varchar(255), primary key (id))
